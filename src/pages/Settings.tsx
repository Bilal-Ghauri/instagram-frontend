      ...
      try {
        ...
        if (apiData) {
          await axios.post("/user/update/user", {
            ...
            profilePicture: apiData?.profilePhoto || user?.profilePicture,
      ...
      <div className="flex mt-10 gap-10">
        <div className="flex-grow-[11] pb-10">
                ...
                <div className="relative overflow-hidden">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      reader.onload = () => {
                        setCoverPhoto({
                          pic: e.target.files && e.target.files[0],
                          blob: reader.result,
                        });
                      };
                    }}
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-3 mt-3">
            ...
            <div>
              <div className="text-lg font-medium">When You Were Born</div>
              <input
                type="date"
                name="DOB"
                value={userData.DOB}
            ...
            <div>
              <div className="text-lg font-medium">Profession</div>
              <input
                type="text"
                name="profession"
